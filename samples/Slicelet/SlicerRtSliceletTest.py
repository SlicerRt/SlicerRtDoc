...
class SlicerRtSliceletTestWidget:
  ...
  def onApply(self):
    ...
    self.logic = SlicerRtSliceletTestLogic(self.grayscaleNode, self.labelNode)
    self.populateStats()
...
class SlicerRtSliceletTestLogic:
  ...
  def __init__(self, grayscaleNode, labelNode, fileName=None):
    ...
    # this->InvokeEvent(vtkSlicerRtSliceletTestLogic::StartLabelStats, (void*)"start label stats")
    ...
    for i in xrange(lo,hi+1):
      ...
      # this->InvokeEvent(vtkSlicerRtSliceletTestLogic::LabelStatsOuterLoop, (void*)event_message.c_str());

      # logic copied from slicer3 SlicerRtSliceletTest
      # to create the binary volume of the label
      # //logic copied from slicer2 SlicerRtSliceletTest MaskStat
      ...
      # this.InvokeEvent(vtkSlicerRtSliceletTestLogic::LabelStatsInnerLoop, (void*)"0.25");
      ...
      # this.InvokeEvent(vtkSlicerRtSliceletTestLogic::LabelStatsInnerLoop, (void*)"0.5")
      ...
      # this.InvokeEvent(vtkSlicerRtSliceletTestLogic::LabelStatsInnerLoop, (void*)"0.75")
      ...
      if stat1.GetVoxelCount() > 0:
        ...
        # this.InvokeEvent(vtkSlicerRtSliceletTestLogic::LabelStatsInnerLoop, (void*)"1")

    # this.InvokeEvent(vtkSlicerRtSliceletTestLogic::EndLabelStats, (void*)"end label stats")
